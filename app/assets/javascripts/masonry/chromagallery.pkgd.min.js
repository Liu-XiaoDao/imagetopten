    ...
    t.extend(a.prototype, {
        ...
        _createGrid: function() {
            ...
            if (this.settings.items) {
                ...
                this.$el.append("<div class='chrg-grid'></div>"), this.grid = this.$el.find(".chrg-grid"), this.$el.find("img").wrap("<div class='chrg-item chrg-no-select' style='width:" + e + "%; margin-bottom:" + this.settings.gridMargin + "px;'></div>").parent().append("<div class='chrg-description'><p>aaaaa</p>eeeee</div>"), this.grid.append(this.$el.find(".chrg-item"))
            }
            this.grid.masonry({
        ...
        _setEvents: function() {
            ...
            }), this.grid.find(".chrg-item").on("mousedown", function(e) {
                if(3 == e.which){ 
		               alert('这是右键单击事件'); 
		          } 
